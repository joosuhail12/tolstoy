...
export class OAuthTokenService {
  ...
  private async performTokenRefresh(config: OAuthConfig, refreshToken: string): Promise<TokenRefreshResponse> {
  ...
  async updateOAuthTokens(toolName: string, orgId: string, tokens: OAuthTokens): Promise<OAuthTokens> {
