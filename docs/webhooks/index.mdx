...
### List Webhooks
```bash
curl https://api.tolstoy.dev/webhooks \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id"
```
...
```bash
curl "https://api.tolstoy.dev/webhooks?eventType=flow.completed" \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id"
```
...
```bash
curl -X PATCH https://api.tolstoy.dev/webhooks/wh_abc123/toggle \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id"
```
...
```bash
curl -X POST https://api.tolstoy.dev/webhooks/wh_abc123/test \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id" \
  -H "Content-Type: application/json" \
  -d '{
...
### Delete Webhook
```bash
curl -X DELETE https://api.tolstoy.dev/webhooks/wh_abc123 \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id"
```
...
```bash
curl https://api.tolstoy.dev/webhooks/wh_abc123/deliveries \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id"
```
