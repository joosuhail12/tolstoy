...
- Access to AWS Secrets Manager (`tolstoy/env`, `conductor-db-secret`)
...
aws secretsmanager get-secret-value --secret-id "conductor-db-secret" --region us-east-1
