...
```bash
curl -X POST https://tolstoy.getpullse.com/tools/tool_abc123/secrets \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl https://tolstoy.getpullse.com/tools/tool_abc123/secrets \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id"
```
...
### List Tools
```bash
curl https://tolstoy.getpullse.com/tools \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id"
```
...
### Get Tool Details
```bash
curl https://tolstoy.getpullse.com/tools/tool_abc123 \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id"
```
...
### Update Tool
```bash
curl -X PATCH https://tolstoy.getpullse.com/tools/tool_abc123 \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id" \
  -H "Content-Type: application/json" \
  -d '{
...
### Delete Tool
```bash
curl -X DELETE https://tolstoy.getpullse.com/tools/tool_abc123 \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id"
```
...
```bash
curl -X POST https://tolstoy.getpullse.com/tools/tool_abc123/test \
  -H "x-org-id: your-org-id" \
  -H "x-user-id: your-user-id" \
  -H "Content-Type: application/json" \
  -d '{
